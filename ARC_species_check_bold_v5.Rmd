...
### Note the above calls all Austroargiolestes "Austroargiolestes spp,", which I think is what we agreed on, no?  (You went with just Austroargiolestes in your commented out code below)
...
for(i in 1:nrow(arc_tfill_checked)){
  ...
  if(!arc_tfill_checked$species_orig[i] %in% unique(bins$species)){
    ...
    if(!arc_tfill_checked$bold_bin_uri[i] %in% binsi$bin_uri){
      ...
      ### the original bin_uri was correct, and the new one is additional. 
