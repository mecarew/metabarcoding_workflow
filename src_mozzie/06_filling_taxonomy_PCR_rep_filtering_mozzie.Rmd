...
metab_long <- final_data_filled %>%
  pivot_longer(cols = A23BNY29042rep1:S22SPL263rep6, names_to = "sample", values_to = "value") %>%
...
final_data_filled_clean <- final_data_filled %>%
  mutate(across(A23BNY29042rep1:S22SPL263rep6, ~ replace_na(.x, 0)))  # Replace NA with 0 in specified columns

# Step 2: Pivot longer
metab_long <- final_data_filled_clean %>%
  pivot_longer(
    cols = A23BNY29042rep1:S22SPL263rep6,  # Specify the range or individual column names
    names_to = "sample",
    values_to = "value"
  ) %>%
