...
metab_long <- final_data_filled %>%
  pivot_longer(cols = A22BNY29042rep1:S21YZJ1175rep6, names_to = "sample", values_to = "value") %>%
...
final_data_filled_clean <- final_data_filled %>%
  mutate(across(A22BNY29042rep1:S21YZJ1175rep6, ~ replace_na(.x, 0)))  # Replace NA with 0 in specified columns

# Step 2: Pivot longer
metab_long <- final_data_filled_clean %>%
  pivot_longer(
    cols = A22BNY29042rep1:S21YZJ1175rep6,  # Specify the range or individual column names
    names_to = "sample",
    values_to = "value"
  ) %>%
