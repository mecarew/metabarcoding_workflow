...
```{r}
#what miseq run are you working on:
miseq_folder <- "miseq20"

#read in MAR2T table to check runs
miseq_controls_long <- read.csv(here::here("results/final_data_summaries", paste0(miseq_folder,"_CONTROLS_long_format_13_09_2024.csv"))) 
mart2_control_data <- readxl::read_excel(here::here("~/Documents/MAR2_metabarcoding_control_site.xlsx"))
```
