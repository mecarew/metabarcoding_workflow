...
```{r}
# save 'thresholds_list' for the next notebook
thresholds_list <- here::here("results/classification/thresholds_list.RData")

save(thresholds_list, file = thresholds_list)
```
