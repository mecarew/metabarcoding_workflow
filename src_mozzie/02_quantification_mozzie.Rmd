...
short_curated_otus_df <- short_curated_otus_df %>% rename(curated_otus = short_curated_otus)

right_curated_otus <- right_lulu$curated_otus
right_curated_otus_df <- if (!is.data.frame(right_curated_otus)) {
 curated_otus <- as.data.frame(right_curated_otus)
}
right_curated_otus_df <- right_curated_otus_df %>% rename(curated_otus = right_curated_otus)
