...
```{r}
# read in flies
file_path <- "~/uomShare/wergStaff/MelCarew/git-data/metabarcoding_workflow/asv_library_97_aug24.xlsx"
...
```{r}
# read in flies
file_path <- "~/uomShare/wergStaff/MelCarew/git-data/metabarcoding_workflow/additions_asv_library_oct24.xlsx"
...
"1d5760deee25f457d5f3aae91017277a" = "Riethia sp. B-ACG9457",
...
max_p_update_df <- max_p_update_df %>%
  mutate(family = ifelse(asv_code %in% names(asv_max_p_identity_corrections_mpu),
...
# Save the workbook
saveWorkbook(wb, "~/uomShare/wergStaff/MelCarew/git-data/metabarcoding_workflow/asv_library_97_aug24_modified.xlsx", overwrite = TRUE)
```
