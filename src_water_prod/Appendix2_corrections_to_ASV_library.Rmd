...
- adding records from subsequent miSeq runs [MEL: is this the right way to describe the origin of the addition records? CHRIS: The additional records were from subsequent miSeq runs];
...
- additions_asv_library_oct24.xlsx (additional records for truncated_fills); [MEL: can you describe where these additional records come from? CHRIS: These are records found requiring updating after the 'asv_library_97_aug24.xlsx' was constructed]
...
# [MEL: code for deleting them if you are sure they really should be deleted. CHRIS: I think that they should be deleted. Thi means they will appear in the miseq data as asv without a species identification]
...
Can you tell me where you got these values from? CHRIS: from check against BOLD or GenBank
