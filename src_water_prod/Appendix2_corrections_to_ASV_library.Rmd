...
#[MEL#3: OK, I think you are saying the BOLD value of 99.3 is the correct one? Based on that, I have left the code below as it was to remove the record with max_p_identity = 98.0.  If you are happy with that, please delete the above set of comments. If not, please change 99.3 to 98.0 and edit the commented-out text justifying the decision above it (and then delete these comments)]
...
#  the problematic taxa that you helped me with in the last revision. Thanks!]
...
# MEL#3. Your suggestions are now be taken below. Please delete these comments if you are happy
