...
water_prod <- "~/git/metabarcoding_workflow"
```
...
Sys.setenv(TMPDIR="/home/unimelb.edu.au")
...
classification_thresholds_dir <- "/home/unimelb.edu.au/mecarew/git/metabarcoding_workflow/thresholds"
...
```{r}
# move 'thresholds' folder to uomshare
file.copy("/home/unimelb.edu.au/mecarew/git/metabarcoding_workflow/thresholds", paste0(uomshare,"classification"), recursive = TRUE)
```
