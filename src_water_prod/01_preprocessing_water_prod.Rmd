...
#***NOTE: YOU WILL NEED TO CHANGE THE MISEQ FOLDER NAME****

results_dir <- "/mnt/uomShare/wergStaff/MelCarew/git-data/miseq15/metabarcoding_workflow"

# Set the directory path for files to be stored on uomshare (NOTE: 'test' will need to be change to your miseq folder name)
uomshare <- "/mnt/uomShare/wergStaff/MelCarew/git-data/miseq15/metabarcoding_workflow/"

# Log files will be stored inside the logs directory inside the results directory
logs_dir <- file.path(results_dir, "logs")

tmp_dir <- "/mnt/uomShare/wergStaff/MelCarew/git-data"
```
