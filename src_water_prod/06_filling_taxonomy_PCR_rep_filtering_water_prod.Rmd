...
#final_df <- read.csv(paste0(uomshare, "/final_data_summaries/", miseq_folder, "_vsearch_data_summary_14_08_2024.csv")) # change the Miseq run number and time stamp
```
...
file_name <- paste0(uomshare, "/final_data_summaries/", miseq_folder, "_vsearch_data_summary_filled", timestamp, ".csv")
