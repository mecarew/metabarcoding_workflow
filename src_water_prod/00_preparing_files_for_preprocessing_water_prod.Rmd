...
metabarcoding_workflow <- "~/uomShare/wergStaff/MelCarew/git-data/miseqXX/metabarcoding_workflow/"
...
# move raw data into the 'metabarcoding workflow' folder for analysis **change directory name to miseq dataset**
file.rename(from = "~/uomShare/wergStaff/MelCarew/git-data/miseq13/raw", to = paste0(metabarcoding_workflow, "data/raw"))
