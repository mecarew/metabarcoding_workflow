...
miseq13_vsearch_sum <- read.csv(paste0(uomshare, "/final_data_summaries/miseq_vsearch_data_summary_14_08_2024.csv"))
miseq15_vsearch_sum <- read.csv(paste0(uomshare, "/final_data_summaries/miseq15_vsearch_data_summary_13_08_2024.csv"))
miseq16_vsearch_sum <- read.csv(paste0(uomshare, "/final_data_summaries/miseq16_vsearch_data_summary_14_08_2024.csv"))
...
file_name1 <- paste0(uomshare, "/final_data_summaries/ten_sites_vsearch_data_summary_filled_flit", timestamp, ".csv") 
...
# Create the file name with the timestamp (NOTE:Change the MiSeq number to the dataset you are working with)
file_name2 <- paste0(uomshare, "/final_data_summaries/ten_sites_vsearch_data_summary_filled_filter_sites_per_", timestamp, ".csv")
