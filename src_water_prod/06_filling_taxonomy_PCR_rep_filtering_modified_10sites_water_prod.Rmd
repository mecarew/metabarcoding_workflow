...
miseq13_vsearch_sum <- read.csv(paste0(uomshare, "/final_data_summaries/miseq13_vsearch_data_summary_05_09_2024.csv"))
miseq15_vsearch_sum <-  read.csv("~/uomShare/wergStaff/MelCarew/git-data/miseq15/metabarcoding_workflow/final_data_summaries/miseq15_vsearch_data_summary_05_09_2024.csv")
...
miseq16_vsearch_sum <- read.csv("~/uomShare/wergStaff/MelCarew/git-data/miseq16/metabarcoding_workflow/final_data_summaries/miseq16_vsearch_data_summary_05_09_2024.csv")
```
...
```{r}
# read in flies
file_path <- "~/uomShare/wergStaff/MelCarew/git-data/asv_library_97_aug24_modified.xlsx"
...
file_name <- paste0(uomshare, "/final_data_summaries/ten_sites_vsearch_data_summary_filled", timestamp, ".csv")
...
dir.create(paste0(uomshare, "/final_data_summaries/modeling_data"))

# Generate a timestamp
timestamp <- format(Sys.time(), "%d_%m_%Y")

# Create the file name with the timestamp (set Miseq run number)
file_name <- paste0(uomshare, "/final_data_summaries/modeling_data/ten_sites_vsearch_data_summary_filled_filt_PCR_long_format_", timestamp, ".csv")
# Save the dataframe with the new file name
...
# Create the file name with the timestamp (set Miseq run number)
cont <- paste0(uomshare, "/final_data_summaries/ten_sites_CONTROLS_long_format_", timestamp, ".csv")
# Save the dataframe with the new file name
