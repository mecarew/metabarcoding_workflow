...
```{r}
dada2_dir <- "/home/unimelb.edu.au/mecarew/git/metabarcoding_workflow/dada2"
...
```{r}
paged_table(read_qza(paste0(uomshare,"results/dada2/short_denoising_stats.qza"))$data)
```

```{r}
paged_table(read_qza(paste0(uomshare, "results/dada2/right_denoising_stats.qza"))$data)
```
...
```{r}
saveRDS(short_lulu, file=paste0(uomshare, "results/lulu/short_lulu.rds"))
```
...
```{r}
saveRDS(right_lulu, file=paste0(uomshare, "results/lulu/right_lulu.rds"))
```
