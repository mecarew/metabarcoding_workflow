...
sum(!samples_c$sitecode %in% sites$sitecode) # 0 sitecodes consistent with sites table
...
# MEL: Note Chris has yet to revise locations of a small number of new sites, which will result in changes to some smpcodes and sitecodes. This should only be treated as a draft at this stage...DO NOT disseminate or use for analysis yet.  Note for CHRIS - code for moving sites in mwbugs_site_update_spring_2022.R
