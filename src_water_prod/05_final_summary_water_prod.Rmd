...
```{r}
#reset directory 
#***NOTE: YOU WILL NEED TO CHANGE THE MISEQ FOLDER NAME to the directory you are working directory****
...
short_classifications <- read_qza(paste0(uomshare,"/classification/short_classification.qza"))
right_classifications <- read_qza(paste0(uomshare,"/classification/right_classification.qza"))
short_seq <- read_qza(paste0(uomshare,"/dada2/short_representative_sequences.qza"))
right_seq <- read_qza(paste0(uomshare,"/dada2/right_representative_sequences.qza"))
```
...
```{r}
# for big dataset
short_search_results <- read_tsv(paste0(uomshare,"/classification/preliminary/short_vsearch.tsv"))
```
...
```{r}
# for big dataset
right_search_results <- read_tsv(paste0(uomshare,"/classification/preliminary/right_vsearch.tsv"))
```
